...
-- Listage des données de la table session_laure.categorie : ~0 rows (environ)
...
-- Listage des données de la table session_laure.formation : ~0 rows (environ)
...
-- Listage des données de la table session_laure.module : ~0 rows (environ)
...
-- Listage des données de la table session_laure.programme : ~0 rows (environ)
