...
class SearchController extends AbstractController
{
    ...
    public function index(CategorieRepository $cr, FormationRepository $fr, ModuleRepository $mr, StagiaireRepository $sr, Request $request, $word = null): Response
    {
